...
:::info
[**Join the Linea Builders Club**](https://t.me/+JMGAPixWzKQyMDY5) to get exclusive access to tech talks, events, the Linea team, and more!
...
## The Linea Forever Hack

**Create, Iterate, and Innovate!** :frog:

Every month, Linea will host a mini, online buildathon to celebrate and reward continuous hacking! We will have a 1ETH pool prize distributed to qualified projects. No need to start from scratch - the only requirement is that you're building with Linea, made progress on your project in the current month, and you've posted about your project on social (and included a frog somewhere)!

This is a great opportunity to win some small prizes alongside your regular building, iteratively improve on past hackathon projects, and get exposure to the Linea team and community!
...
- You can make multiple submissions, but we will only award prizes to one submission per user
...
**What are examples of acceptable work**
...
- UX - how easy is it for a user to navigate or how easy it is to follow the tutorial
- Utility - how useful is your project
- Technicality - how complex was this project to build
- WOW factor - a catch-all vibe check for projects that are simply fun to interact with or pushing the boundaries of on-chain use cases
...
Find the submission deform linked under the current month.

### April 2024 (1 ETH pool prize + $1000 USD [efrog](https://twitter.com/efrogs_on_linea) pool prize) :frog:

This month, you can win both the 1ETH pool prize in addition to extra prize money from the [efrog community](https://twitter.com/efrogs_on_linea).

**Submissions due 11:59PM EST, April 30th, 2024**

**Submit your project here: https://linea.deform.cc/foreverhack-april-2024**
...
For our this inaugural Forever Hack, efrogs is joining us to sponsor an additional $1000 in prizes to any project that incorporates efrogs in some form. Judging will favor projects that actually incorporate the efrog smart contract, but using the image assets is sufficient to qualify as well!
