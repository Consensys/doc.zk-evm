...
A fraud proof (fault proof) is the evidence provided by a verifier to question the state of a transaction. Depending on how it's executed, this proof scrutinizes a section of the transactions and endeavors to confirm their validity.
